...
enable_random_offset = True  # 随机偏移功能开关
...
def load_prefix_variables():  # 加载前置参数
    ...
    try:
        ...
        time_interval = settings.get("time_interval", 1)  # 随机瞄准偏移时间间隔（s）
        enable_random_offset = settings.get("enable_random_offset", False)  # 随机瞄准偏移开关
