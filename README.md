...
**🎉🎉🎉非常感谢由 Ricardo Joaquim 提供的英文特别版本🎉🎉🎉**  


更新日志：    
 7/15/2024更新：  
 🎛️版本更新：V2.4.4.2(beta)/V2.5.0(bera)   
 概要：V2.4.4.2(beta)版更新‘忽略颜色’功能/V2.5.0(bera)版重构代码  
 ➕新增：V2.4.4.2(beta)忽略颜色功能，有助于单标签模型区分敌我。     
 🛠️优化：V2.5.0(beta)，@molanp对V2.4.3版本的代码进行优化，Python要求>=3.10    
 📑新增文件：V2.5.0(beta)     
 👋感谢：@molanp：重构并优化V2.4.3版本代码。@CougarP：对于颜色忽略功能的支持。    
 -------------------------------------------------------------  
 7/8/2024更新：  
 🎛️版本更新：V2.4.3   
 ...
 👋感谢：@molanp：提供使用API请求更新公告的办法，使请求与加载速度更快更稳定！    
 🕳️V2.4.4计划：自动扳机，停止瞄准范围。  
 -------------------------------------------------------------  
 7/3/2024更新：  
 🎛️版本更新：V2.4.2   
 概要：修复V2.4.1正式版的BUG  
 ...
 ➕新增：随机特征码  
 ➕新增：随机窗口名  
 ➕新增：鼠标移动库选择：1.win32 2.mouse 3.飞易来U盘 4.罗技移动（需下载旧版GHUB，安装包在LGmouseControl文件夹中）  
 ➕新增：x轴瞄准偏移  
 ...
 📑新增文件：1.罗技移动DLL（MouseControl.dll） 2.罗技GHUB以及相关文件（LGmouseControl文件夹）     
 👋感谢：@loy0516：提出加入睡眠，防止刷在加载的建议。@CougarApp：提供英文版以及英文版特有功能：添加 PID 控制，使鼠标移动更平滑、更精确，颜色忽
略，识别检测框上方区域中的颜色，如果颜色与所选颜色匹配，则忽略框等。这些功能稍后会同步到中文版中。  
 🕳️V2.4.2计划：垂直压枪，自动扳机，kmbox兼容  
 ...
 🕳️V2.3.3计划：加入垂直压枪功能；完善水平瞄准偏移GUI页面；推理参数兼容选择。  
 -------------------------------------------------------------   
 5/30/2024更新：  
 🎛️版本更新：V2.3.2  
 ➕新增：对TRT模型的兼容。现在可以正常使用*.engine模型进行推理。        
 📑V2.4.0测试版：易键鼠版本，基于v2.3.1修改。仅推荐懂易键鼠的开发者使用，该版本旨在绕过某些屏蔽win32移动方式的游戏使用（例如瓦，虽然已经似了），同时更难被检测。目前处于半成品状态且需自行购入易键鼠U盘，不推荐小白使用。  
 -------------------------------------------------------------   
 5/12/2024更新：  
 🎛️版本更新：V2.3.1 （正式版）   
