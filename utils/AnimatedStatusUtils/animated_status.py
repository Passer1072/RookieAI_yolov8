...
class AnimatedStatus:
    ...
    def show_status_widget(self, message, bg_color, text_color, font_size=14, padding=(5, 10, 5, 10), auto_hide=None):
        ...
        self.status_display_widget_animation = QPropertyAnimation(self.status_widget, b"pos") # type: ignore
        ...
        self.opacity_animation = QPropertyAnimation(self.status_display_widget_opacity, b"opacity") # type: ignore
